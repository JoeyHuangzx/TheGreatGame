...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddButtonListener", _m_AddButtonListener);
        ...
        static int _m_GetButton(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.UI.Button gen_ret = gen_to_be_invoked.GetButton(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddButtonListener(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Action __cb = translator.GetDelegate<System.Action>(L, 2);
                    
                    gen_to_be_invoked.AddButtonListener( __cb );
